...
export function SiteFooter({ className }: SiteFooterProps) {
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 text-center text-sm text-[var(--muted)] md:flex-row md:items-center md:text-left">
        <p className="text-center md:text-left">
          © {new Date().getFullYear()} {site.name}. All rights reserved.
        </p>
        <blockquote className="max-w-md text-pretty text-center md:max-w-lg md:text-right">
